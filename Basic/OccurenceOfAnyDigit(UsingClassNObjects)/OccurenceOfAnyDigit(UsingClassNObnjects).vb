Module Module1
    ...
    Sub Main()
        ...
        Dim FindingNumberOfDigitsIn1ToN As FindNumberOfDigits = New FindNumberOfDigits()

        Console.WriteLine("                                         PROGRAM TO FIND NUMBER OF ANY DIGITS IN ) TO N")
        Console.WriteLine("                                     **-------------------------------------------------** ")
        ...
        For i = 1 To test
            ...
            'FindingNumberOfDigitsIn1ToN.methodOneFindingNumberOfDigits(num, digit)
            FindingNumberOfDigitsIn1ToN.secondOneFindingNumberOfDigits(num, digit)
